...
@Component({
  selector: 'app-trustee-manage',
  templateUrl: './trustee-manage.component.html',
  styleUrls: ['./trustee-manage.component.scss']
})
export class TrusteeManageComponent implements OnInit, AfterViewInit, OnDestroy {

  trusteeObj: TrusteeModel;
  id: number;
    ...
    if (res) {
      switch (res.code) {
        case ServerResponseEnum.SUCCESS:
          this.trusteeObj = TrusteeModel.fromJson(res.data);
          this.bindData();
          break;
