...
import { ITableListFilter, ICityVillageList, LabelKey } from '@vsd-common/lib';
...
export class CityVillageComponent implements OnInit, AfterViewInit {
  ...
  constructor(private httpService: HttpService,
    ...
    this.pageTitle.setTitle(this.labelService.getLabel(LabelKey.SIDE_MENU_CITY_VILLAGE));
