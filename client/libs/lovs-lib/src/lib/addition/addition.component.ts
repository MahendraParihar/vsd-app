...
import { ITableListFilter, IAddictionList, LabelKey } from '@vsd-common/lib';
...
export class AdditionComponent implements OnInit, AfterViewInit {
  ...
  constructor(private httpService: HttpService,
    ...
    this.pageTitle.setTitle(this.labelService.getLabel(this.labelKeys.SIDE_MENU_ADDICTION));
