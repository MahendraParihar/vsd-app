...
export class JobStatusComponent implements OnInit, AfterViewInit {
  ...
  add() {
    this.navigationService.navigateTo(NavigationPathEnum.JOB_STATUS_MANAGE);
  }

  edit(obj: IJobStatusList) {
    this.navigationService.navigateToById(NavigationPathEnum.JOB_STATUS_MANAGE, obj.jobStatusId);
  }
