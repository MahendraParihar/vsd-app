...
import { ITableListFilter, IContactTypeList, LabelKey } from '@vsd-common/lib';
...
export class ContactTypeComponent implements OnInit, AfterViewInit {
  ...
  constructor(private httpService: HttpService,
    ...
    this.pageTitle.setTitle(this.labelService.getLabel(LabelKey.SIDE_MENU_CONTACT_TYPE));
