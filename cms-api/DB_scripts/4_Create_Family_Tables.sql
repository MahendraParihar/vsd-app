...
CREATE TABLE IF NOT EXISTS txn_family (
  ...
  CONSTRAINT tf_mst_app_user_id_fk FOREIGN KEY (app_user_id) REFERENCES mst_app_user (app_user_id)
);
...
CREATE INDEX ix_family_service_family_id
...
CREATE INDEX ix_matrimonial_eduction_m_id
  ON txn_family_education_mapping (family_id);
