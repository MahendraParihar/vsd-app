...
CREATE TABLE IF NOT EXISTS txn_event_interested_member (
  ...
  created_at  TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at  TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT tei_app_user_id_fk FOREIGN KEY (app_user_id) REFERENCES mst_app_user (app_user_id),
...
CREATE TABLE IF NOT EXISTS txn_email_status (
  ...
  CONSTRAINT tes_mst_app_user_id_fk FOREIGN KEY (app_user_id) REFERENCES mst_app_user (app_user_id)
);
