...
@Component({
  selector: 'lovs-lib-manage-relationship',
...
export class ManageRelationshipComponent implements OnInit {
  ...
  constructor(
    ...
    this.pageTitle = this.labelService.getLabel(this.id ? this.labelKeys.EDIT_RELATIONSHIP : this.labelKeys.ADD_RELATIONSHIP);
