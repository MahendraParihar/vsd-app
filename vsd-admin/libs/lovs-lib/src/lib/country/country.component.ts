...
@Component({
  selector: 'lovs-lovs-lib-country',
  standalone: false,
...
export class CountryComponent implements OnInit, AfterViewInit {
  ...
  add() {
    this.addEvent.emit(NavigationPathEnum.COUNTRY_MANAGE);
  }

  edit(obj: ICountryList) {
    this.editEvent.emit({path: NavigationPathEnum.COUNTRY_MANAGE, id: obj.countryId});
  }
