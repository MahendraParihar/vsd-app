...
@Component({
  selector: 'lovs-lib-contact-type',
  standalone: false,
...
export class ContactTypeComponent implements OnInit, AfterViewInit {
  ...
  add() {
    this.addEvent.emit(NavigationPathEnum.CONTACT_TYPE_MANAGE);
  }

  edit(obj: IContactTypeList) {
    this.editEvent.emit({ path: NavigationPathEnum.CONTACT_TYPE_MANAGE, id: obj.contactTypeId });
  }
