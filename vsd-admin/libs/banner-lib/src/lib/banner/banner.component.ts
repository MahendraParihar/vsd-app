...
@Component({
  selector: 'banner-lib-banner-list',
...
export class BannerComponent implements OnInit, AfterViewInit {
  ...
  add() {
    this.addEvent.emit(NavigationPathEnum.BANNER_MANAGE);
  }

  edit(obj: IBannerList) {
    this.editEvent.emit({path: NavigationPathEnum.BANNER_MANAGE,id: obj.bannerId});
  }

  async changeStatus(index: number, obj: IBannerList) {
